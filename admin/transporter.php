                        ...
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                ...
                                <p>Sign in today for more expirience.</p-->
                                        ...
                                        <form action="transporter2.php" method="post">
                                            ...
                                            <div class="form-group"><label>Phone Number</label> <input type="text" name="phone" placeholder="" class="form-control"></div>
                                            <div class="form-group"><label>District</label> <input type="text" name="district" placeholder="" class="form-control"></div>
                                            <div class="form-group"><label>Truck model</label> <input type="text" name="truck_model" placeholder="" class="form-control"></div>
                                            <div>
