                        ...
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                ...
                                <p>Sign in today for more expirience.</p-->
                                        ...
                                        <form action="farmer2.php" method="post">
                                            ...
                                            <div class="form-group"><label>EPA</label> <input type="text" name="epa" placeholder="" class="form-control"></div>
                                            <div class="form-group"><label>Trading Center</label> <input type="text" name="tc" placeholder="" class="form-control"></div>
                                            <div class="form-group"><label>Phone number</label> <input type="tel" name="phone" placeholder="" class="form-control"></div>
                                            <div class="form-group"><label>National ID number</label> <input type="text" name="nid" placeholder="" class="form-control"></div>
                                            <div>
