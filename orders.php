...
<?php
     $id=$_SESSION['user_id'];
     $sql = "SELECT  DISTINCT oid FROM orders where user_id=$id";
...
<div class="cart-main-area mtb-60px">
                <div class="container">
                    <h3 class="cart-page-title">List of All Your Orders</h3>
                    <div class="row">
  ...
  <?php
    ...
    <tr>
        ...
        <input type="hidden" name="view_id"  value="<?php echo  $row['oid']; ?>" >
        <td> <input type="submit" value="View" name="view_btn"></td>
        <td><a href="all_products.php?view=<?php echo $row['oid']; ?>">submitted</a></td>
       
        <td> <input type="submit" value="Cancel" name="view_btn">
      </form></td>
